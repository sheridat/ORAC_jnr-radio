...
class Radio:
	...
	def muted(self):
		return self.isMuted
	##########################################################################
	# the following three functions relate to the muting of the LCD display  #
	# the request to mute/unmute is provided by IR key KEY_DISPLAYTOGGLE..   #
	##########################################################################
	...
	def getCurrentID(self):
		try:
			...
			log.message("radio.getCurrentID calling getCurrentSong ", log.DEBUG)
			log.message("note taht if song is changed that is written to a file ", log.DEBUG)
	...
	def getCurrentSong(self):
		try:
			...
			log.message("radio.getCurrentSong is calling mpd to get current song", log.DEBUG)
